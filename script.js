const questions = [
  { letter: 'A', question: 'Experiencia emocionante y a veces peligrosa que implica descubrir cosas nuevas.', answer: 'aventura', status: 0 },
  { letter: 'B', question: 'Ave nocturna que tiene grandes ojos y puede girar la cabeza casi completamente', answer: 'buho', status: 0 },
  { letter: 'C', question: 'Conjunto de conocimientos que se obtienen mediante la observación y el razonamiento.', answer: 'ciencia', status: 0 },
  ...
  { letter: 'E', question: 'Comunidad de seres vivos y el lugar donde viven, como un bosque o un lago.', answer: 'ecosistema', status: 0 },
  ...
  { letter: 'N', question: 'Todo lo que existe en el mundo sin la intervención del ser humano, como plantas y animales.', answer: 'naturaleza', status: 0 },
  { letter: 'Ñ', question: 'Lugar donde vivimos', answer: 'españa', status: 0 },
  { letter: 'O', question: 'Gran extensión de agua salada que cubre la mayor parte de la Tierra.', answer: '', status: 0 },
  ...
  { letter: 'X', question: 'Gas raro que se usa en luces especiales.', answer: 'xenon', status: 0 },
